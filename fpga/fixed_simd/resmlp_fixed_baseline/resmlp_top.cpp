...
int main () {
	...
	size_t totel_hardware_w_n = hardware_w_size_bytes;
	...
	// Split the weights into 4 channels for burst access
	// std::cout << "Splitting weights into 4 channels" << std::endl;
	// accel_w_vec_t *hardware_w_ch1 = NULL;
	// accel_w_vec_t *hardware_w_ch2 = NULL;
	// accel_w_vec_t *hardware_w_ch3 = NULL;
	// accel_w_vec_t *hardware_w_ch4 = NULL;
	// size_t hardware_w_ch_size_bytes = hardware_w_size_bytes / 4;
	// std::cout << hardware_w_ch_size_bytes << std::endl;
	// posix_memalign((void**)&hardware_w_ch1, 4096, hardware_w_ch_size_bytes);
	// posix_memalign((void**)&hardware_w_ch2, 4096, hardware_w_ch_size_bytes);
	// posix_memalign((void**)&hardware_w_ch3, 4096, hardware_w_ch_size_bytes);
	// posix_memalign((void**)&hardware_w_ch4, 4096, hardware_w_ch_size_bytes);
	// split_4<accel_w_vec_t, PORT_VEC_SIZE>(
	// 	hardware_w,
	// 	hardware_w_ch1,
	// 	hardware_w_ch2,
	// 	hardware_w_ch3,
