...
OUTPUT_FOLDER="./output/${DATASET}/resmlp_layers_4_h_4_embed_96/bspline_65_${BSPLINE_LAMBDA}"
...
python ${SCRIPT} --dataset-dir ${DATASET_DIR} ${DATASET_DOWNLOAD_FLAG} \
--teacher-load $TEACHER_MODEL --do-kt --do-kd --student-hidden-factor 0.25 --student-nl-act bspline \
--disable-tqdm --bspline-lambda ${BSPLINE_LAMBDA} \
